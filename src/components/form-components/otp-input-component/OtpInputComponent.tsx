...
import SingleOTPInputComponent from "./SingleOTPInputComponent";
...
export function OTPInputComponent(props: OTPInputProps) {
  ...
  const [otpValues, setOTPValues] = useState(
    (formField?.value ? formField?.value : value)?.split("") ||
  ...
  const handleOtpChange = useCallback(
    (otp: string[]) => {
      ...
      formField ? formField.onChange(otpValue) : void 0;
    },
    [onChangeOTP, formField]
  );
